...
class GPayment(PaymentMethod):
    def pay(self, amount):
        print(f'Processing Google payment for ${amount}')
...
g_pay = GPayment()
g_payment_processor = PaymentProcessor(g_pay)
g_payment_processor.process_payment(order_obj)
